...
module.exports = [
  ...
  { username: 'Anna', hashed_password: '$2a$10$5NrWbSt6Xlpwj8sxc.Qbc.6kbqHWkIVm2rFsGzk.EYs9T810OBgOC', email: 'Anna@gmail.com', profile_pic: 'http://res.cloudinary.com/dvzbt8kfq/image/upload/v1459329574/user_photos/6753395_orig_ljd4zt.jpg', credits: 9, active_streak: 1, doa: moment().add(1, 'days'), created_at: moment(), updated_at: moment() }

  { username: 'Ashley', hashed_password: '$2a$10$7akg0S14IzfqQc1YR9qI6.hr/R3nTTbpg506EAHoyta7.8aGiRdTe', email: 'AshleyStanbridge@icloud.com', profile_pic: 'http://res.cloudinary.com/dvzbt8kfq/image/upload/v1459329574/user_photos/6753395_orig_ljd4zt.jpg', credits: 9, active_streak: 1, doa: moment().add(1, 'days'), created_at: moment(), updated_at: moment() }
